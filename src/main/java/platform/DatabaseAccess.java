...
final class DatabaseAccess {
    ...
    boolean CheckAvailability(String username) throws SQLException {
    ...
    int[] GetSystemStats() throws SQLException {
        Connection con = dataSource.getConnection();
    ...
    UserStat GetUserStats(int userID) throws SQLException {
        Connection con = dataSource.getConnection();
    ...
    void CreateUser(String username, String password) throws SQLException, NoSuchAlgorithmException {
        Connection con = dataSource.getConnection();
    ...
    User LoginUser(String username, String password) throws SQLException, NoSuchAlgorithmException {
        Connection con = dataSource.getConnection();
    ...
    List<Item> getUserItems(int userID) throws SQLException {
    ...
    List<Auction> getActiveAuctions() throws SQLException {
    ...
    List<Auction> checkWonAuctions(int userID) throws SQLException {
        List<Auction> list = new ArrayList<>();
        Connection con = dataSource.getConnection();
    ...
    void markWinnerNotified(Auction auction) throws SQLException {
        Connection con = dataSource.getConnection();
    ...
    private List<Auction> fillAuctionInfo(List<Auction> list, Connection con, PreparedStatement ps) throws SQLException {
        ...
        while (rs.next()) {
            ...
            Date close = rs.getTimestamp("closeDate");
    ...
    void createItem(String name, String desc, Item.ItemDamage dmg, int userID) throws SQLException {
        Connection con = dataSource.getConnection();
    ...
    void createAuction(int userID, double startPrice, double reservePrice, int length, int itemID) throws SQLException {
        Connection con = dataSource.getConnection();
    ...
    void placeBid(int auctionID, int userID, double bid) throws SQLException {
        Connection con = dataSource.getConnection();
    ...
    void updateDatabaseInfo() throws SQLException {
    ...
    Auction getAuction(int auctionID) throws SQLException {
        List<Auction> list = new ArrayList<>();
        Connection con = dataSource.getConnection();
    ...
    class UserStat {
        ...
        int auctions;
        int bid;
        UserStat(String username, int auctions, int bid) {
